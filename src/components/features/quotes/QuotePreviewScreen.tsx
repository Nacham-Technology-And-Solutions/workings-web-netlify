  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <header className="bg-white border-b border-gray-200 p-4 flex justify-between items-center sticky top-0 z-40">
        ...
        <div className="flex items-center gap-2">
          <button onClick={onEdit} className="hidden lg:flex items-center gap-2 px-3 py-1.5 text-sm font-semibold text-gray-700 hover:text-gray-900" aria-label="Edit quote">
            <EditIcon />
            <span>Edit</span>
          </button>
          <button
      ...
      <footer className="bg-white p-4 shadow-[0_-5px_15px_rgba(0,0,0,0.1)] fixed bottom-0 left-0 right-0 z-10 border-t border-gray-200">
        <div className="max-w-3xl mx-auto">
          <button
            ...
            className="w-full py-4 bg-gray-800 text-white text-lg font-semibold rounded hover:bg-gray-700 transition-colors"
          >
            Download as PDF
          </button>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end sm:items-center justify-center">
          <div className="bg-white rounded-t-3xl sm:rounded-3xl w-full sm:max-w-md p-6 animate-slide-up">
            ...
            <div className="space-y-3">
              <button
                onClick={() => handleExportOption('pdf')}
                className="w-full py-4 bg-gray-50 hover:bg-gray-100 text-gray-900 font-semibold rounded transition-colors text-left px-6 flex items-center gap-4"
              >
