...
<svg width="320" height="340" viewBox="0 0 320 340" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(85, 20)">
        ...
        {/* Header */}
        <text x="38" y="32" fontFamily="Exo 2, sans-serif" fontSize="10" fontWeight="500" fill="#1F2937">Olumide Residence Renovat...</text>
        ...
        <text x="30" y="68" fontFamily="Exo 2, sans-serif" fontSize="8" fill="#0284C7" textAnchor="middle" fontWeight="600">3/4</text>
        <text x="55" y="62" fontFamily="Exo 2, sans-serif" fontSize="9" fill="#4B5563">Project description</text>
        <text x="55" y="72" fontFamily="Exo 2, sans-serif" fontSize="8" fill="#9CA3AF">Fill in all the necessary details</text>
        ...
        <text x="18" y="165" fontFamily="Exo 2, sans-serif" fontSize="8" fill="#9CA3AF" transform="rotate(-90 18 165)">1200</text>
        <text x="78" y="98" fontFamily="Exo 2, sans-serif" fontSize="8" fill="#9CA3AF">1200</text>
        
        <text x="75" y="248" fontFamily="Exo 2, sans-serif" fontSize="9" fill="#374151" textAnchor="middle" fontWeight="500">2 Panels</text>
        <text x="130" y="258" fontFamily="Exo 2, sans-serif" fontSize="8" fill="#9CA3AF">mm</text>
...
<svg width="320" height="340" viewBox="0 0 320 340" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(40, 50) rotate(-5)">
        ...
        <text x="15" y="30" fontFamily="Exo 2, sans-serif" fontSize="10" fill="#6B7280">Quantity</text>
        <text x="225" y="30" fontFamily="Exo 2, sans-serif" fontSize="10" fill="#374151" textAnchor="end">20 length</text>
        <line x1="15" y1="40" x2="225" y2="40" stroke="#E5E7EB" strokeWidth="1"/>
        
        <text x="15" y="65" fontFamily="Exo 2, sans-serif" fontSize="12" fill="#374151" fontWeight="500">Layout A</text>
        <text x="150" y="65" fontFamily="Exo 2, sans-serif" fontSize="10" fill="#6B7280">Repetition</text>
        <text x="225" y="65" fontFamily="Exo 2, sans-serif" fontSize="12" fill="#111827" fontWeight="600" textAnchor="end">6X</text>
        <rect x="15" y="75" width="160" height="18" rx="4" fill="#3B82F6"/>
        <text x="95" y="87" fontFamily="Exo 2, sans-serif" fontSize="9" fill="white" textAnchor="middle">4.5m</text>
        <rect x="180" y="75" width="45" height="18" fill="#F3F4F6" rx="4"/>
        <rect x="180" y="75" width="45" height="18" fill="url(#grid-pattern-3)" rx="4"/>
        <text x="15" y="105" fontFamily="Exo 2, sans-serif" fontSize="9" fill="#9CA3AF">Off-cut: 1.5m</text>
        
        <line x1="15" y1="125" x2="225" y2="125" stroke="#F3F4F6" strokeWidth="1"/>
        
        <text x="15" y="150" fontFamily="Exo 2, sans-serif" fontSize="12" fill="#374151" fontWeight="500">Layout B</text>
        <text x="150" y="150" fontFamily="Exo 2, sans-serif" fontSize="10" fill="#6B7280">Repetition</text>
        <text x="225" y="150" fontFamily="Exo 2, sans-serif" fontSize="12" fill="#111827" fontWeight="600" textAnchor="end">3X</text>
        <rect x="15" y="160" width="50" height="18" rx="4" fill="#3B82F6"/>
        <text x="40" y="172" fontFamily="Exo 2, sans-serif" fontSize="9" fill="white" textAnchor="middle">1.2m</text>
        <rect x="70" y="160" width="50" height="18" rx="4" fill="#3B82F6"/>
        <text x="95" y="172" fontFamily="Exo 2, sans-serif" fontSize="9" fill="white" textAnchor="middle">1.2m</text>
        <rect x="125" y="160" width="48" height="18" rx="4" fill="#3B82F6"/>
        <text x="149" y="172" fontFamily="Exo 2, sans-serif" fontSize="9" fill="white" textAnchor="middle">1.1m</text>
    </g>
</svg>
);
