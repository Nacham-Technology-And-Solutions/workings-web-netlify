...
// Nav bar icons from design file: /icons/{name}-icon-{filled|outline}.svg
const NAV_ICONS_BASE = '/icons';

export const HomeIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/home-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const ProjectsIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/projects-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const QuotesIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/quotes-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const MaterialListIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/materials-list-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const TemplatesIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/pre-built-template-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const HelpIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/help-and-tips-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const FeedbackIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/feedback-and-contact-us-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const SettingsIcon: React.FC<{ isActive?: boolean }> = ({ isActive }) => (
  <img src={`${NAV_ICONS_BASE}/settings-icon-${isActive ? 'filled' : 'outline'}.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);

export const LogoutIcon: React.FC<{ isActive?: boolean }> = () => (
  <img src={`${NAV_ICONS_BASE}/log-out-icon-outline.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);
...
export const WorkingsLogo: React.FC<{ className?: string; isAnimated?: boolean }> = ({ className, isAnimated }) => (
  <div className={`${className ?? ''} ${isAnimated ? 'logo-animated' : ''}`}>
    <img
      src={`${APP_LOGOS_BASE}/app-secondary-logo.svg`}
      alt="Workings"
...
/** Icon only (for favicon or compact spaces) */
export const AppIcon: React.FC<React.ImgHTMLAttributes<HTMLImageElement>> = (props) => (
  <img src={`${APP_LOGOS_BASE}/app-icon.svg`} alt="" className="w-full h-full object-contain" aria-hidden {...props} />
);

/** Wordmark only */
export const AppWordmark: React.FC<React.ImgHTMLAttributes<HTMLImageElement>> = (props) => (
  <img src={`${APP_LOGOS_BASE}/app-wordmark.svg`} alt="Workings" className="h-full w-auto object-contain" {...props} />
);
...
export const DoubleCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M22 8L13 17L10 14" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
// Settings screen tab icons (single state from design file)
const SETTINGS_ICONS_BASE = '/icons';

export const ProfileIcon: React.FC = () => (
  <img src={`${SETTINGS_ICONS_BASE}/settings-screen-icons-profile.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);
export const BillingsIcon: React.FC = () => (
  <img src={`${SETTINGS_ICONS_BASE}/settings-screen-icons-billings.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);
export const SubscriptionPlansIcon: React.FC = () => (
  <img src={`${SETTINGS_ICONS_BASE}/settings-screen-icons-subscription-plans.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);
export const ExportSettingsIcon: React.FC = () => (
  <img src={`${SETTINGS_ICONS_BASE}/settings-screen-icons-export-settings.svg`} alt="" className="w-6 h-6 flex-shrink-0" aria-hidden />
);
